-- Initialize our search data table and create the triggers
-- needed to maintain it.
--
-- NOTE: Run this script as a superuser account such as ROOT

-- Setup the FULLTEXT indices since they aren't created by websetup.py
ALTER TABLE media_fulltext
	ADD FULLTEXT INDEX `media_public` (`title`,`subtitle`,`description_plain`,`tags`,`categories`),
	ADD FULLTEXT INDEX `media_admin` (`title`,`subtitle`,`description_plain`,`notes`,`tags`,`categories`);

-- Copy our data into the fulltext-searchable table
