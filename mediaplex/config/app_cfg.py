...
class MediaplexConfig(AppConfig):
    def setup_routes(self):
        ...
        map.connect('/video-{action}/{slug}', slug=None, controller='video', requirements=dict(action='tags|flow|flow_ajax|upload|upload_submit|upload_submit_async|upload_success'))
