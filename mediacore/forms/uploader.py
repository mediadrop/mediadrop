...
class UploadForm(ListForm):
    ...
    class fields(WidgetsList):
        name = TextField(validator=validators['name'], label_text='Your Name:', show_error=True, maxlength=50)
        ...
        title = TextField(validator=validators['title'], label_text='Title:', show_error=True, maxlength=255)
        description = XHTMLTextArea(validator=validators['description'], label_text='Description:', attrs=dict(rows=5, cols=25), show_error=True)
        tags = TextField(validator=validators['tags'], label_text='Tags:', help_text='(optional) e.g.: puppies, great dane, adorable', show_error=True)
