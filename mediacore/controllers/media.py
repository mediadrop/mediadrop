...
class MediaController(BaseController):
    ...
    @expose('mediacore.templates.media.lessons')
    @paginate('media', items_per_page=20)
    ...
    @expose('mediacore.templates.media.lesson_view')
    ...
    @expose('mediacore.templates.media.concept_view')
    ...
    @expose('mediacore.templates.media.concept_preview')
